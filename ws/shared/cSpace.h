...
public:
    ...
    Eigen::Vector2d getPointFromCell(std::size_t indexX0, std::size_t indexX1) const;
...
public:
    MyGridCSpace2DConstructor() 
        : m_x0_min(0.0),  // Assuming 0.0 is a sensible default
          m_x0_max(2*M_PI),  // Assuming 1.0 is a sensible default
          m_x1_min(0.0),  // Assuming 0.0 is a sensible default
          m_x1_max(2*M_PI),  // Assuming 1.0 is a sensible default
          m_x0_cells(50), // Assuming 10 is a sensible default
          m_x1_cells(50)  // Assuming 10 is a sensible default
    {
    }
